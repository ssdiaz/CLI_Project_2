...
class CurlyProductCheck::CLI
    ...
    def display_categories
        puts "\nHair Categories:"
        @all_categories.sort_by{|obj| obj.name}.each.with_index(1) do |category, index|
    ...
    def show_brands_for(user_category)
        ...
        @category_chosen.brands.sort_by{|obj| obj.name}.each.with_index(1) do |brand, index|
    ...
    def show_products_for(user_brand)
        ...
        @brand_chosen.products.sort_by{|obj| obj.name}.each.with_index(1) do |product, index|
    ...
    #     appropriate_repsonse = ["Y", "y", "N", "n"]
    #     user_answer = gets.strip.to_s
        
    #     until appropriate_repsonse.include?(user_answer)
    #         puts "Unidentified character. Type Y/N:"
    #         user_answer = gets.strip.to_s
    #     end
